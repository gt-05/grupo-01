...
export default function Footer() {
    return (
        <>
            <footer className="w-full h-[454px] mt-[3290px] text-white bg-[#1F1F1F] ">
                ...
                <div className="flex pt-8 justify-center">
                    ...
                    <div name="Logo" className="flex flex-col pt-6">
                        ...
                        <ul className="flex flex-nowrap">
                            <li><a href="#"></a><img src="/src/assets/Facebook.png" alt="" className="mr-8 mt-8" /></li>
                            <li><a href="#"></a><img src="/src/assets/Instagram.png" alt="" className="mr-8 mt-8" /></li>
                            <li><a href="#"></a><img src="/src/assets/twitter.png" alt="" className="mr-8 mt-8" /></li>
                        </ul>
                    </div>
